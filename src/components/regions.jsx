      ...
      <div className="max-w-6xl  w-full p-0 bg-neutral-100 text-center grid grid-cols-2 md:grid-cols-1 ">
        ...
        <div className="pt-12">
          ...
          <p className="tracking-wider font-light  font-roboto  text-medium w-3/4 my-0 mx-auto mb-4">
            ...
            is the home of various civilizations.For this reason,ancient sites
            and cities in Turkey generally spread over a whole asia minor land.
          </p>
          <p className="tracking-wider font-light  font-roboto  text-medium w-3/4 my-0 mx-auto">
            Initially we are giving a start with three regions at the west side
            of Anatolia.More regions will follow soon.
          </p>
          <button
