          ...
          <div>
            <div className="grid  grid-cols-3 gap-6 my-4 mt-12">
              <div className="w-91 h-53 relative">
                ...
                <img src={ads1} className=" w-91 h-53 object-cover  " />

                <div className="w-91 h-53 absolute top-0 left-0  bg-slate-100 w-full h-full opacity-20   hover:opacity-10 transition-all   "></div>
              </div>
            ...
            "
              ...
              <div className="col-span-2 row-span-2 w-190 h-112 relative">
                ...
                <img
                  ...
                  className="w-190 h-112 object-cover  "
                />
                <div className="w-190 h-112 absolute top-0 left-0  bg-slate-100 w-full h-full opacity-20   hover:opacity-10 transition-all   "></div>
              </div>
              <div className="w-91 h-53 relative">
                <h3 className="absolute text-xl uppercase font-medium top-16  text-center w-full text-white z-5">
                  Troia
