          ...
          <div>
            <div className="grid  grid-cols-3 gap-6 my-4 mt-12">
              <div className="w-91 h-53 relative">
                ...
                <h3 className=" absolute text-xl uppercase font-medium  top-16  text-center w-full text-white z-10">
                  Troia
                </h3>
                <p className=" absolute text-2xl uppercase font-bold whitespace-nowrap tracking-wide top-24 w-full text-white z-10 font-roboto">
                  Camel Herders of
                </p>
                <p className=" absolute text-2xl uppercase font-bold   tracking-wide top-32 w-full text-white z-10 font-roboto">
                  Gallipoli
                </p>
                ...
                <img
                  src={nat5}
                  alt="nat5"
                  className=" w-91 h-53 object-cover opacity-70 hover:opacity-100   transition-all  duration-500 ease-in-out"
                />
              </div>
              ...
              <div className="w-91 h-53 relative">
                ...
                <p className="absolute  text-2xl uppercase font-bold  mb-2 tracking-wide top-32 w-full text-white z-10 font-roboto">
                  Gallipoli
                </p>
              ...
              opacity-70 hover:opacity-100   transition-all  duration-500 ease-in-out"
                />
              </div>

              <div className="col-span-2 row-span-2 w-190 h-137 relative">
                <h3 className="text-2xl uppercase font-medium absolute w-full text-center top-40 text-white z-10">
                  Troia
                </h3>
                <p className="absolute w-full text-center text-3xl uppercase font-bold whitespace-nowrap tracking-wide top-48 text-white z-10 font-roboto">
                  Camel Herders of Gallipoli
                </p>
                ...
                <img
                  src={nat7}
                  alt="nat7"
                  className="w-190 h-137 object-cover opacity-70 hover:opacity-100   transition-all  duration-500 ease-in-out "
                />
              </div>
              <div className="w-91 h-53 relative">
                <h3 className="absolute text-xl uppercase font-medium top-16  text-center w-full text-white z-10">
