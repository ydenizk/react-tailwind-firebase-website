...
import banner from "./../assets/sagalassos/banner.jpg";
import big from "./../assets/sagalassos/592-360-1.jpg";
import big1 from "./../assets/sagalassos/592-288.jpg";
import big2 from "./../assets/sagalassos/592-360.jpg";
          ...
          <div className="  w-full p-0 text-black grid grid-cols-6 gap-2 px-2">
            ...
            <div className="w-full   col-span-2">
              <div className="w-full bg-neutral-100  ">
                ...
                <p className="font-medium text-base font-garamond tracking-wider text-gray-500">
                  ...
                  <a
                    ...
                    href="https://goo.gl/maps/dJ1zq63QU3U9BPTW7"
                    target="_blank"
                  >
                    Google Maps
                  </a>
                ...
                <p className="font-medium text-base font-garamond tracking-wider text-gray-500">
                  Brochure -
                  <a
                    href="https://muze.gov.tr/s3/MysFileLibrary/Burdur%20Sagalassos-bfdf69ba-479e-4ad4-9a52-c65237ee3b9c.pdf"
                ...
                <p className="font-medium text-base font-garamond tracking-wider text-gray-500">
                  ...
                  <a
                    ...
                    href="https://whc.unesco.org/en/tentativelists/5409/"
                    target="_blank"
                  >
                    Unesco
                  </a>
                ...
                <a
                  ...
                  href="https://en.wikipedia.org/wiki/Sagalassos"
                  target="_blank"
                >
                  Wikipedia
                </a>
              ...
              <div className="w-72 h-72 mt-20 mb-4 ">
                <img src={small} alt="object-cover w-72 h-72 " />
              </div>

              <div className="w-72 h-72  mb-4 ">
                <img src={small1} alt="object-cover  w-72 h-72 " />
              </div>
            </div>
          </div>
