      ...
      <div className="max-w-6xl  w-full p-0 bg-neutral-100 ">
        <div className="text-center mb-16">
          <div className="w-96 h-96  my-0 mx-auto mb-12">
            <img src={image} alt="" className="w-96 h-96 object-cover rounded-full contrast-125 " />
          </div>
          ...
          return (
            ...
            >
              ...
              <div className=" text-left flex-1">
                ...
                <p className="mb-2 tracking-wider font-light text-normal font-roboto">
                  {text}{" "}
                </p>
                  ...
                  {places.map((pl, index) => {
                    return (
                      <>
                        <h4
                          key={index}
                          className="p-2 pl-0 whitespace-nowrap font-roboto text-base tracking-wider hover:text-amber-400 transition-all"
                        >
                          {pl}{" "}
                        </h4>
                      </>
