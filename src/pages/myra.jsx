...
import banner from "./../assets/myra/banner.jpg";
import big from "./../assets/myra/592-360.jpg";
import big1 from "./../assets/myra/592*360.jpg";
import big2 from "./../assets/myra/592-212.jpg";
  ...
  return (
    <div className="w-full bg-neutral-100 md:mt-20">
      <Helmet>
        ...
        <meta
          name="description"
          content="Home of one of the the most important cities of Lycia"
        />
